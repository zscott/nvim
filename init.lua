...
vim.keymap.set('n', '<leader>bn', '<cmd>bn<CR>', { desc = 'Move to [N]ext buffer' })
vim.keymap.set('n', '<leader>bp', '<cmd>bp<CR>', { desc = 'Move to [P]revious buffer' })
vim.keymap.set('n', '<leader>bd', '<cmd>bn<CR><cmd>bd#<CR>', { desc = '[D]elete buffer' })
vim.keymap.set('n', '<leader>bl', '<cmd>ls<CR>', { desc = '[L]ist buffers' })
vim.keymap.set('n', '<leader>bb', '<cmd>Telescope buffers<CR>', { desc = '[B]uffer [B]rowser' })
